...
### Get in the flow with FlowBio!

![](https://raw.githubusercontent.com/NCBI-Hackathons/FlowBio/master/images/pipeline.png)

# Usage

![autoflow process](https://raw.githubusercontent.com/NCBI-Hackathons/FlowBio/master/images/usage_overview.png)
...
Nextflow will recognise NCBI-Hackathons/FlowBio and download the pipeline from GitHub. The `-profile` docker configuration lists the ncbihackathons/atacflow image that we have created and is hosted at dockerhub, and this is downloaded.
...
```bash
singularity pull --name ncbihackathons-flowbio.img docker://ncbihackathons/FlowBio
```
